 ...
 */
@javax.persistence.Table(name = "oa_teacher_info", schema = "", catalog = "eduoa")
@Entity
public class OaTeacherInfoEntity {
    ...
    @javax.persistence.Column(name = "teacher_number")
    @Basic
    ...
    @javax.persistence.Column(name = "is_teacher")
    @Basic
    Integer getTeacher() {
        return isTeacher;
    }
    ...
    @javax.persistence.Column(name = "political_landscape")
    @Basic
    ...
    @javax.persistence.Column(name = "working_time")
    @Basic
    Date getWorkingTime() {
        return workingTime;
    }
    ...
    @javax.persistence.Column(name = "original_education")
    @Basic
    ...
    @javax.persistence.Column(name = "original_education_time")
    @Basic
    ...
    @javax.persistence.Column(name = "new_education")
    @Basic
    ...
    @javax.persistence.Column(name = "new_education_time")
    @Basic
    ...
    @javax.persistence.Column(name = "establishment")
    @Basic
